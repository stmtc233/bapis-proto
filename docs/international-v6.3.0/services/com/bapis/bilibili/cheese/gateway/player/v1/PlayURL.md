# `com.bapis.bilibili.cheese.gateway.player.v1.PlayURL`
...
| 14 | `isRawStream` | `bool` | - | 是否 流 |
| 15 | `securityLevel` | `SecurityLevel` | - | 等级 |
...
| 4 | `riskControl` | `RiskControl` | - | 业务字段 `riskControl`（名称未提供可靠中文语义） |
| 5 | `watermarkConfig` | `WatermarkConfig` | - | 配置 |
...
| 13 | `flvProj` | `bool` | - | 业务字段 `flvProj`（名称未提供可靠中文语义） |
| 14 | `aid` | `int64` | - | 稿件 ID |
