...
| `DmSegCache` | 一元调用 | `com.bapis.bilibili.community.service.dm.v1.DmSegCacheReq` | `com.bapis.bilibili.community.service.dm.v1.DmSegMobileReply` | 弹幕 |
...
| 27 | `switchState` | `PlayerDanmakuSwitchState` | - | 状态 |
...
### 请求 `com.bapis.bilibili.community.service.dm.v1.DmSegCacheReq`
...
| 1 | `type` | `int32` | - | 类型 |
| 2 | `oid` | `int64` | - | 对象 ID |
| 3 | `pid` | `int64` | - | 业务字段 `pid`（名称未提供可靠中文语义） |
...
| 7 | `curLanguage` | `string` | - | 业务字段 `curLanguage`（名称未提供可靠中文语义） |
| 8 | `curProductionType` | `ProductionType` | - | 类型 |
| 9 | `withoutSubtitle` | `bool` | - | 业务字段 `withoutSubtitle`（名称未提供可靠中文语义） |
