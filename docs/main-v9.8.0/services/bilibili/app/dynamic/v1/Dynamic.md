...
| `DynMixUpListSearch` | 一元调用 | `com.bapis.bilibili.app.dynamic.v1.DynMixUpListSearchReq` | `com.bapis.bilibili.app.dynamic.v1.DynMixUpListSearchReply` | 列表 搜索 |
| `DynMixUpListViewMore` | 一元调用 | `com.bapis.bilibili.app.dynamic.v1.NoReq` | `com.bapis.bilibili.app.dynamic.v1.DynMixUpListViewMoreReply` | 列表 查看 |
...
| `GeoCoder` | 一元调用 | `com.bapis.bilibili.app.dynamic.v1.GeoCoderReq` | `com.bapis.bilibili.app.dynamic.v1.GeoCoderReply` | `GeoCoder` 调用 |
| `OurCityClickReport` | 一元调用 | `com.bapis.bilibili.app.dynamic.v1.OurCityClickReportReq` | `com.bapis.bilibili.app.dynamic.v1.OurCityClickReportReply` | 点击 |
...
### 请求 `com.bapis.bilibili.app.dynamic.v1.DynMixUpListSearchReq`
...
### 响应 `com.bapis.bilibili.app.dynamic.v1.DynMixUpListSearchReply`
...
### 请求 `com.bapis.bilibili.app.dynamic.v1.NoReq`

中文说明：请求。

该消息没有声明字段。

### 响应 `com.bapis.bilibili.app.dynamic.v1.DynMixUpListViewMoreReply`
...
| 13 | `refreshCity` | `uint32` | - | 业务字段 `refreshCity`（名称未提供可靠中文语义） |
| 14 | `expConf` | `ExpConf` | - | 业务字段 `expConf`（名称未提供可靠中文语义） |
| 15 | `playerArgs` | `com.bapis.bilibili.app.archive.middleware.v1.PlayerArgs` | - | 播放器 |
| 16 | `cityCode` | `int64` | - | 状态码 |
| 17 | `buildTime` | `int64` | - | 时间 |
...
| 2 | `isNewInstall` | `bool` | - | 是否 |
| 3 | `isCodeStart` | `bool` | - | 是否 状态码 开始 |
| 4 | `newFollowUpMids` | `int64` | repeated | 关注 |
| 5 | `reqScene` | `DynRedReqScene` | - | 请求 |
...
| 4 | `redStyle` | `DynRedStyle` | - | 业务字段 `redStyle`（名称未提供可靠中文语义） |
| 5 | `tabRecallExtra` | `string` | - | 标签页 扩展数据 |
| 6 | `bubbleInfo` | `BubbleInfo` | - | 信息 |
| 7 | `statusText` | `string` | - | 状态 文本 |
...
### 请求 `com.bapis.bilibili.app.dynamic.v1.GeoCoderReq`
...
### 响应 `com.bapis.bilibili.app.dynamic.v1.GeoCoderReply`

中文说明：响应。

| 字段号 | 字段 | Proto 类型 | 修饰 | 中文说明 |
| --- | --- | --- | --- | --- |
| 1 | `address` | `string` | - | 业务字段 `address`（名称未提供可靠中文语义） |
| 2 | `addressComponent` | `AddressComponent` | - | 业务字段 `addressComponent`（名称未提供可靠中文语义） |
| 3 | `adInfo` | `AdInfo` | - | 广告 信息 |

### 请求 `com.bapis.bilibili.app.dynamic.v1.OurCityClickReportReq`
...
### 响应 `com.bapis.bilibili.app.dynamic.v1.OurCityClickReportReply`
...
| 11 | `playerPreload` | `PlayerPreloadParams` | - | 播放器 |
| 12 | `focusAid` | `int64` | - | 稿件 ID |
| 13 | `playerArgs` | `com.bapis.bilibili.app.archive.middleware.v1.PlayerArgs` | - | 播放器 |
...
| 2 | `offset` | `string` | - | 偏移量 |
| 3 | `hasMore` | `int32` | - | 是否具有 |
| 4 | `top` | `SVideoTop` | - | 业务字段 `top`（名称未提供可靠中文语义） |
