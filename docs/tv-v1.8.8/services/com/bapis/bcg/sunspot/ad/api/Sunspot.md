# `com.bapis.bcg.sunspot.ad.api.Sunspot`

中文说明：广告 接口 业务 服务。说明根据接口标识符自动推断，实际业务语义以客户端实现和服务端行为为准。

## RPC

| 方法 | 调用模式 | 请求 | 响应 | 中文说明 |
| --- | --- | --- | --- | --- |
| `AdSearch` | 一元调用 | `com.bapis.bcg.sunspot.ad.vo.SunspotAdRequestForView` | `com.bapis.bcg.sunspot.ad.vo.SunspotAdReplyForView` | 广告 搜索 |

## 请求与响应字段

### 请求 `com.bapis.bcg.sunspot.ad.vo.SunspotAdRequestForView`
...
| 28 | `device` | `string` | - | 设备 |
| 29 | `from` | `string` | - | 来源 |
| 30 | `requestType` | `string` | - | 请求 类型 |

### 响应 `com.bapis.bcg.sunspot.ad.vo.SunspotAdReplyForView`

中文说明：广告 响应 查看。

| 字段号 | 字段 | Proto 类型 | 修饰 | 中文说明 |
| --- | --- | --- | --- | --- |
| 1 | `adsControl` | `google.protobuf.Any` | - | 业务字段 `adsControl`（名称未提供可靠中文语义） |
